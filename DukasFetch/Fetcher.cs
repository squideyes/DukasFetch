...
internal class Fetcher
{
        ...
        int hour, CancellationToken cancellationToken)
    {
        ...
        var minTickOn = (DateTime)TickSet.Session.MinTickOn;
        ...
        while (reader.BaseStream.Position != reader.BaseStream.Length)
        {
            ...
            var tickOn = new TickOn(
                minTickOn.AddHours(hour).AddMilliseconds(ms));
    ...
    private Uri GetUri(int hour)
    {
        ...
        var mto = ((DateTime)TickSet.Session.MinTickOn)
            .ToUtcFromEastern().AddHours(hour);
